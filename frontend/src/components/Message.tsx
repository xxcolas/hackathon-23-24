...
const Message = ({ data }) => {
  ...
  return (
    <section className="absolute animate-slideUp h-4/5 w-[400px] bg-white rounded-lg border-solid border-blue-300 right-5 bottom-5 shadow-md ">
      ...
      {client.messages.map((item, index) => (
        ...
        >
          <div className="chat-bubble bg-blue-600 group-data-[state=practitioner]:bg-green-600 text-white">
            {item.text}
          </div>
